        ...
        with connect() as conn:
            with conn.cursor() as cursor:
                cursor.execute(
                    ...
                    'interactionMaterial_uuids, contactCard_uuids) VALUES (%s, %s, %s, %s, %s, %s, %s)',
                    (self.location_uuid, self.interactionType, self.startTime, self.endTime, self.uuid, exten.adapt(self.interactionMaterial_uuids), exten.adapt(self.contactCard_uuids)))
