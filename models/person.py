...
class Person:
    ...
    def save_to_db(self):
        connection = psycopg2.connect(user='mpstaton', database='snapshot_dev', host='localhost')
        with connection.cursor() as cursor:
            cursor.execute(
                'INSERT INTO persons (called, givenName, surName, maidenName, birthDate, gender, hasUserAccount, '
